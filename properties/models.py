...
class Property(models.Model):
    ...
    description = models.CharField(max_length=255, default='A beautiful place')
    image = models.ImageField(upload_to='property_picture/', blank=True, null=True)
    user_id = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)
    created = models.DateTimeField(default=timezone.now)
    status = models.CharField(max_length=11, null=False, choices=STATUS)
...
class RoomsType(models.Model):
    ...
    bed_type = models.CharField(max_length=6, null=False, choices=BED_TYPE)
    bathroom_type = models.CharField(max_length=8, null=False, choices=BATHROOM_TYPE)
